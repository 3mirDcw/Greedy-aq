...
exports.run = async (client, message, args) => {
  ...
  let sahip = '738367168961577020​' //Premium verebilicek / alabilecek kişiler
  let log = client.channels.cache.get('790875613438935111​ID') // logların tutulcağı kanal
  ////--------------------------------------------\\\\     
...
.setDescription(`Bu sunucu için **Premium** **${açıkmı ? 'aktif' : 'kapalı'}**!`)
